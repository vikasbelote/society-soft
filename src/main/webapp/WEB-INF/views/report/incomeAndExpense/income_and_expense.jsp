...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form:form id="inserAndUpdateForm" commandName="incomeAndExpenseDomain"
			class="form-horizontal" action="incomeAndExpense">

			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right">Current
					Year <i class="fa fa-asterisk" style="color: red;"></i>
				</label>
