<div class="page-header">
	<h1>Society Configuration Status</h1>
</div>
<!-- /.page-header -->
			...
			<div class="well">
				<h1 class="grey lighter smaller">
					<span class="blue bigger-125"> <i
						class="ace-icon fa fa-check"></i> ${ successMsg }
					</span> 
				</h1>
				...
				<div>
					...
					<ul class="list-unstyled spaced inline bigger-110 margin-15">
						<li><i class="ace-icon fa fa-hand-o-right blue"></i> Re-check
							the url for typos</li>
				...
				<div class="center">
					<a href="societyConfig" class="btn btn-grey"> <i
						class="ace-icon fa fa-arrow-left"></i> Go Back
					</a> <a href="home" class="btn btn-primary"> <i
